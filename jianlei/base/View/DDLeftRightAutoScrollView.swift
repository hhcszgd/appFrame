...
//    }
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int{
        self.pageControl.align = .right
        self.pageControl.frame = CGRect(x: 0, y:self.bounds.height - 40 , width: 0, height: 0)
        //        self.pageControl.center = CGPoint(x: self.bounds.width/2, y: self.bounds.height - 40)
    ...
    class Item : UICollectionViewCell {
        ...
        override func layoutSubviews() {
            super.layoutSubviews()
            imageView.frame = CGRect(x: MARGIN, y: MARGIN, width: self.bounds.width - MARGIN * 2, height: self.bounds.height - MARGIN * 2)
