...
class GDIBContentView: UIView {
    ...
    var showingPage : Int  = 0 {
        didSet{
            ...
            attStr.addAttribute(NSAttributedString.Key.font, value: UIFont(name: "HelveticaNeue-Bold", size: 29) ?? DDFont(), range: NSRange.init(location: 0, length: currentPage.characters.count) )
